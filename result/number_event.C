...
void number_event (){
	...
	//TFile *f1 =TFile::Open("/Users/lf/Desktop/muon-collider/estarlight/build/ep_eRHIC/total/rate.root");
	TFile *f2 =TFile::Open("/Users/lf/Desktop/muon-collider/estarlight/build/ep_LHeC/total/number_event.root");
	TFile *f3 =TFile::Open("/Users/lf/Desktop/muon-collider/estarlight/build/ep_MuIC/total/number_event.root");
	TFile *f4 =TFile::Open("/Users/lf/Desktop/muon-collider/estarlight/build/ep_MuIC2/total/number_event.root");
	TFile *f5 =TFile::Open("/Users/lf/Desktop/muon-collider/estarlight/build/ep_LHmuC/total/number_event.root");
	//TGraph *gr1=(TGraph *)f1->Get("mrp");
	

	TGraphErrors *gr2=(TGraphErrors *)f2->Get("mrp");
	TGraphErrors *gr3=(TGraphErrors *)f3->Get("mrp");
	TGraphErrors *gr4=(TGraphErrors *)f4->Get("mrp");
	TGraphErrors *gr5=(TGraphErrors *)f5->Get("mrp");
	...
	gr5->GetYaxis()->SetTitle("Number of events per year , #Delta y=0.5");
	gr5->SetTitle("");
	gr5->Draw();
	gr5->Draw();
	...
	leg1->AddEntry(gr2,"LHeC(Run 6):e(60 Gev)+p(7 TeV)","l");
