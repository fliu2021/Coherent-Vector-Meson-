...
void rate (){
	...
	TFile *f2 =TFile::Open("/Users/lf/Desktop/muon-collider/estarlight/build/ep_LHeC/total/rate.root");
	TFile *f3 =TFile::Open("/Users/lf/Desktop/muon-collider/estarlight/build/ep_MuIC/total/rate.root");
	TFile *f4 =TFile::Open("/Users/lf/Desktop/muon-collider/estarlight/build/ep_MuIC2/total/rate.root");
	TFile *f5 =TFile::Open("/Users/lf/Desktop/muon-collider/estarlight/build/ep_LHmuC/total/rate.root");
	...
	gr2->SetLineStyle(2);
	gr2->SetLineWidth(3);
	gr2->GetXaxis()->SetTitle("J/#psi Rapidity");
	gr2->GetYaxis()->SetTitle("Generation Rate[10^{3} s^{-1}] per #Delta y=0.5");
	gr2->SetTitle("");
	gr2->Draw();
	gr2->Draw("C");
